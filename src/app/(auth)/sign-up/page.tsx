...
import  {TAuthParamsSingup , resolvers } from "@/Validator/SingupValidator"
import SignUphandler from "@/handler/sing-up";
...
const page = () => {
  ...
  const {
    ...
    formState: { errors },
    handleSubmit,
  } = useForm <TAuthParamsSingup>({
    resolver: resolvers
  });


  async function EventSubmit ( value : TAuthParamsSingup) {
